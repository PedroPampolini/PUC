...
class Program{
    ...
    public static void printaTabela(double[][] tabela, double[][] saida){
        ...
        for(int i = 0; i < tabela.Length; i++){
            ...
            System.Console.WriteLine(saida[i][0]);
        }
    }
    ...
    static void Main(string[] args){
        ...
        Func<double, double> activationFunction = NeuralNetwork.Functions.Linear;
        Func<double, double> dactivationFunction = NeuralNetwork.Functions.DLinear;
        ...
        while (opcao != -1){
            switch (opcao)
            {
                ...
                case 1:
                    ...
                    nn = new NeuralNetwork(new int[] {tabela.Length,10, 1}, learningRate: 0.001, epochs: epochs, tolerate: 0.001, activationFunction: activationFunction, dactivationFunction: dactivationFunction);
                    nn.train(tabela, saida, epochs, log: true);
                    treinado = true;
                    porta = "AND";
                    break;
                ...
                case 4:
                    ...
                    double saidaTeste = nn.FeedFoward(entradasTeste)[0];
