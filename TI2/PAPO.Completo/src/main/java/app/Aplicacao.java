...
public class Aplicacao {
	public static void main(String[] args){
		...
		get("/insertProfessor/:id/:username/:nome/:email/:telefone/:password/:genero/:dataNasc/:cep/:cidade/:estado/:papel/:Experiencia/:descricao",
				(request,response) -> Service.insertProfessor(request));
		get("/updateProfessor/:id/:username/:nome/:email/:telefone/:password/:genero/:dataNasc/:cep/:cidade/:estado/:papel/:Experiencia/:descricao",
