...
public class LZW {
    ...
    private void compressFile(String inFile, String outFile) throws IOException{
        ...
        try {
            ...
            //Loop que irá percorrer todo o arquivo comprimindo e salvando no arquivo de saída
            while(true){
                int porc = (int)((100 * in.getFilePointer()) / in.length());
                String barra = new String();
                //Imprime a barra de progresso
                barra = "||";
                for(int j = 0; j < porc / 5; j++){
                    barra += "=";
                }
                for(int j = 0; j < (99 - porc) / 5; j++){
                    barra += " ";
                }
                System.out.print(barra + "|| " + porc + "%\r");
    ...
    //Reinicializa o dicionário e o array de strings com os caracteres iniciais ASCII
    ...
    private void decompressFile(String inFile, String outFile) throws IOException{
        ...
        try {
            ...
            while(true){
                ...
                //a string do caractere anterior concatenado com o primeiro caractere dela mesma
    ...
    private int get12BitValue(byte b1, byte b2, boolean bitEsq){
        ...
        //Verifica se possuiem mais que 12 bits, e remove os da esquerda e seleciona apenas os 8 ultimos
        if(s1.length() > 8){
