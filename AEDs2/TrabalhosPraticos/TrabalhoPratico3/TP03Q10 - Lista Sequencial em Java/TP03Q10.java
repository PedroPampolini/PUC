...
class List{
   ...
   public void insert(Filme f, int pos) throws Exception{
      ...
      if (pos == 0) {
         ...
         for (int i = 0; i < pos; i++,pointer = pointer.prox);
         Node tmp = new Node(f);
         tmp.prox = pointer.prox;
         pointer.prox = tmp;
         tmp = pointer = null;
      }
   }
   ...
   public Filme removeInicio() throws Exception{
      ...
      Filme f = primeiro.prox.elemento;
      Node tmp = primeiro;
   ...
   public Filme remove(int pos) throws Exception{
      ...
      if(pos == 0){
         ...
         Node pointer = primeiro;
         for (int i = 0; i < pos; i++, pointer = pointer.prox);
         Node tmp = pointer.prox;
         pointer.prox = tmp.prox;
         f = tmp.elemento;
   ...
   public String toString(){
      String s = new String();
      Node tmp = primeiro.prox;
      for(int i = 0; tmp != null; i++, tmp = tmp.prox){
         s += "[" + i + "] " + tmp.elemento.toString() + "\n";
      }
      return s;
   }
